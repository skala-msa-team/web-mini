export const liveTrialMock = Object.freeze({
  ...
  phase: '변론',
  participants: [
    { id: 'a-attorney', name: 'A측 AI 변호사', role: '원고 측', position: 'left', tone: 'navy' },
    { id: 'judge', name: 'AI 판사', role: '재판 진행', position: 'center', tone: 'judge' },
    { id: 'b-attorney', name: 'B측 AI 변호사', role: '피고 측', position: 'right', tone: 'blue' },
  ],
  judgeNotice: 'A측 AI 변호사, 최후 변론을 시작하세요.',
  currentArgument: {
    speaker: 'AI 변호사 A (원고 측)',
    content:
      '존경하는 배심원 여러분, 피고인은 이성 친구와 단둘이 술을 마시지 않기로 한 연인 간의 신뢰를 명백히 저버렸습니다. 이는 단순한 우정의 범위를 넘어 원고에게 심리적 불안감을 조성한 중대한 약속 위반입니다.',
  },
  nextSummary: {
    title: 'B측(피고) 주장 요약 대기',
